    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0;">
      <el-form :inline="true" :model="listQuery" label-position="left">
        ...
        <el-form-item>
          ...
          <el-button icon="el-icon-plus" type="primary" v-if="hasPermission('auth:menu:add')" @click="handleCreate">{{$t('common.add')}}</el-button>
          <el-button icon="el-icon-edit" type="primary" v-if="hasPermission('auth:menu:update')" @click="handleUpdate">{{$t('common.edit')}}</el-button>
          <el-button icon="el-icon-delete" type="danger" v-if="hasPermission('auth:menu:delete')" @click="handleDelete">{{$t('common.delete')}}</el-button>
        </el-form-item>
      </el-form>
    </el-col>
